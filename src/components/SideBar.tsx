...
import { useSideBarContext } from "../contexts/Context"
...
const SmallSidebarItem = ({ IconOrImgUrl, title, url }: SmallSidebarItemProps) => {
    ...
    return (
        <a href={url} className={twMerge(buttonStyles({variant: "ghost"}), "py-4 [x-1 flex flex-col items-center rounded-lg gap-1")}>
